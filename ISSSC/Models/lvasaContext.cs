...
namespace ISSSC.Models
{
    public partial class SscisContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                IConfigurationRoot configuration = new ConfigurationBuilder()
                    ...
                    .Build();
                optionsBuilder.UseLazyLoadingProxies().UseMySQL(configuration.GetConnectionString("ZCU"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("enum_role", "lvasa");
            ...
            {
                entity.ToTable("enum_subject", "lvasa");
            ...
            {
                entity.ToTable("participation", "lvasa");
            ...
            {
                entity.ToTable("sscis_content", "lvasa");
            ...
            {
                entity.ToTable("sscis_param", "lvasa");
            ...
            {
                entity.ToTable("sscis_session", "lvasa");
            ...
            {
                entity.ToTable("sscis_user", "lvasa");
            ...
            {
                entity.ToTable("tutor_application", "lvasa");
            ...
            {
                entity.ToTable("tutor_application_subject", "lvasa");
